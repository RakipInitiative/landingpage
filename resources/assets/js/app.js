  ...
  */
   ...
   */
		...
		value: function _createModal() {
			...
			// modal nav
			O._$modalNav = $('<div class="modal-body sim-select"></div>').appendTo(O._$modalContent);
			...
			// modal params
			O._$modalParams = $('<div class="modal-body p-0 sim-params"></div>').appendTo(O._$modalContent);
			// param content container
			O._$modalParams._$content = $('<div class="tab-content h-100"></div>').appendTo(O._$modalParams);

			// modal execution
			O._$modalExecution = $('<div class="modal-body p-0 sim-execution"></div>').appendTo(O._$modalContent);
   ...
   */
		...
		value: function _createSimActions() {
			var O = this;
			_log('MODAL SIM / _createSimActions');
   ...
   */
		...
		value: function _createParamMetadataList(param) {
			var O = this;
			_log('MODAL SIM / _createParamMetadataList');
   ...
   */
		...
		value: function _createFormField(param) {
			var O = this;
			_log('MODAL SIM / _createFormField');
			_log(param);
   ...
   */
		...
		value: async function _updateModal(event) {
			...
			O._loader._setState(true); // set loader
			O._setState('params'); // reset state to form params when opening modal
   ...
   */
		...
		value: function _populateSimSelect() {
			var O = this;
			_log('MODAL SIM / _populateSimSelect');
   ...
   */
		...
		value: function _populateSimForm() {
			var O = this;
			_log('MODAL SIM / _populateSimForm');
   ...
   */
		...
		value: function _updateSimIndex(simIndex) {
			var O = this;
			_log('MODAL SIM / _updateSimIndex: ' + simIndex);
   ...
   */
		...
		value: function _updateSimForm(simIndex) {
			...
			var O = this;
			_log('MODAL SIM / _updateSimForm: ' + simIndex);
   ...
   */
		...
		value: function _updateSimActions(simIndex) {
			var O = this;
			_log('MODAL SIM / _updateSimActions');
   ...
   */
		...
		value: function _updateSimDescription($input) {
			var O = this;
			_log('MODAL SIM / _updateSimDescription');
   ...
   */
		...
		value: function _addSimulation() {
			var O = this;
			_log('MODAL SIM / _addSimulation', 'secondary');
   ...
   */
		...
		value: function _removeSimulation() {
			var O = this;
			_log('MODAL SIM / _removeSimulation', 'secondary');
   ...
   */
		...
		value: async function _saveSimulation() {
			var O = this;
			_log('MODAL SIM / _saveSimulation', 'secondary');
			// run validation
   ...
   */
		...
		value: async function _validateSimForm() {
			var O = this;
			_log('MODAL SIM / _validateSimForm');
   ...
   */
		...
		value: function _validateSimField(field) {
			var O = this;
			_log('MODAL SIM / _validateSimField');
			_log(field);
   ...
   */
		...
		value: function _setState(state) {
			var O = this;
			_log('MODAL SIM / _setState: ' + state);
...
var APPTableMT = function (_APPTable) {
   ...
   */
		...
		value: async function _search(query) {
			...
			var result = await _fetchData._json(_endpoints.search, query);
...
var APPLandingpage = function () {
   ...
   */
		...
		value: async function _create() {
			...
			// endpoints defined?
			if ((typeof _endpoints === 'undefined' ? 'undefined' : _typeof(_endpoints)) != (typeof undefined === 'undefined' ? 'undefined' : _typeof(undefined))) {

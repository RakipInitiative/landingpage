...
<html lang="en">
    <head>
        ...
        <title>RAKIP Model Repository Disclaimer</title>
    ...
    <body>
        ...
        <!-- bfr app js -->
        <script src="${representation.rakip_endpoint}/assets/js/disclaimer.js"></script>
        <!-- page script for initializing app -->
        <script src="${representation.rakip_endpoint}/assets/js/disclaimer_scripts.js"></script>
        <script>

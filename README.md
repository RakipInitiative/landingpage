...
* `context`: Path of the application if deployed under an application container. For example for https://my-domain/landingpage the context is `landingpage`. This can be omitted for local applications not running in a container.
